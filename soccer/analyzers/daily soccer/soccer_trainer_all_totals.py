...
class FormEnhancedSoccerTrainer:
    ...
    def __init__(self, api_key=API_KEY):
        ...
        self.markets = [
            ...
            'h1_over_0_5',       # First half Over 0.5 goals
            'h1_over_1_5',       # First half Over 1.5 goals
        ]
    ...
    def extract_match_data(self, fixture: dict, league_id: int, season: int) -> dict:
        ...
        try:
            ...
            return {
                ...
                'h1_total_goals': home_ht + away_ht,
            }
        except Exception as e:
            return None
    ...
    def create_labels_for_match(self, match: dict) -> dict:
        ...
        # Full-time total goals markets
        labels['over_2_5'] = 1 if match['total_goals'] > 2.5 else 0
        labels['over_3_5'] = 1 if match['total_goals'] > 3.5 else 0
        labels['over_1_5'] = 1 if match['total_goals'] > 1.5 else 0
        ...
        # First half markets
        labels['h1_over_0_5'] = 1 if match['h1_total_goals'] > 0.5 else 0
        labels['h1_over_1_5'] = 1 if match['h1_total_goals'] > 1.5 else 0
