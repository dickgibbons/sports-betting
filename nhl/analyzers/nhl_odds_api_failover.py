...
class NHLOddsFailover:
    """Failover system for NHL odds - tries multiple sources"""
    ...
    def _try_espn_api(self, home_team: str, away_team: str) -> Optional[Dict]:
        ...
        # ESPN API endpoint for NHL odds
        url = "https://sports.core.api.espn.com/v2/sports/hockey/leagues/nhl/events"

        try:
            # First get current NHL events
...
def test_odds_failover():
    ...
    print("🏒 Testing NHL Odds Failover System")
    print("=" * 80)

    failover = NHLOddsFailover()

    # Test with a real NHL matchup
    test_games = [
