#!/usr/bin/env python3
"""
NHL Enhanced Trainer with Team Totals and Back-to-Back Games
Trains models for:
...
class NHLTrainerWithTotalsB2B:
    """Train ML models with team totals and back-to-back tracking"""
    ...
    def __init__(self, hockey_api_key: str = "960c628e1c91c4b1f125e1eec52ad862"):
        ...
        print("🏒 NHL Enhanced ML Trainer with Totals & B2B initialized")
    ...
    def collect_training_data_with_totals(self, num_games: int = 400) -> Tuple[np.array, Dict[str, np.array]]:
        ...
        print(f"\n📊 Collecting training data with team totals and B2B tracking...")
        ...
        try:
            ...
            print(f"   📊 Features: {len(self.feature_names)} (including B2B tracking)")
    ...
    def save_models(self, filepath: str = "nhl_models_with_totals_b2b.pkl"):
        """Save all models"""
...
def main():
    """Train NHL models with team totals and B2B tracking"""

    print("="*80)
    print("🏒 NHL MODEL TRAINING - With Team Totals & Back-to-Back Tracking")
    print("="*80)
    ...
    if len(X) > 0:
        ...
        print(f"\n✅ NHL ML models ready with team totals and B2B tracking!")
        print(f"   Features include: days rest, back-to-back indicator, rest differential")
